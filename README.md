# SQL-анализ продуктовых метрик мобильной игры Planet Hunt
...
- `game_assets_catalog` — справочник игровых объектов;
- `invite_network` — данные реферальной программы;
- `item_price_history` — история изменения стоимости игровых объектов;
- `player_activity_log` — информация об игровых сессиях пользователей;
- `players_profile` — информация о зарегистрированных игроках и их основных характеристиках;
- `purchase_events` — данные о внутриигровых покупках.
...
* `data_dictionary.md` — словарь данных с описанием таблиц и полей, использованных в анализе;
* `project_description.md` — описание игры Planet Hunt, её игровой механики, монетизации и реферальной программы;
* `technical_specification.md` — техническое задание на проведение аналитического исследования.
