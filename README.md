...
* `data_dictionary.md` — описание структуры исходных данных, таблиц и их полей;
* `project_description.md` — описание бизнес-задачи, целей и основных направлений анализа;
